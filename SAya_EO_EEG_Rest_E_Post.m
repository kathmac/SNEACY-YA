...
% 
% eeglab;
workpath = '/Volumes/Data/ZShared/SNEACY/2_SNEACY_YA/SNEACY_YA_EEG/EO_EEG/EO_EEG_Rest_E/Post/';  % This is the path to your main processing folder
...
%Excel output
filename = 'SAya_EO_EEG_Rest_E_Post.xlsx'
