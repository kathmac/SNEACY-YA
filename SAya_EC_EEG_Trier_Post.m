...
% 
eeglab;
workpath = '/Volumes/Data/ZShared/SNEACY/2_SNEACY_YA/SNEACY_YA_EEG/EC_EEG/EC_EEG_Trier/Post/';  % This is the path to your main processing folder
...
%Excel output
filename = 'SAya_EC_EEG_Trier_Post.xlsx'
