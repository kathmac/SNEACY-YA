...
% 
eeglab;
workpath = '/Volumes/Data/ZShared/SNEACY/2_SNEACY_YA/SNEACY_YA_EEG/EC_EEG/EC_EEG_Rest_T/Pre/';  % This is the path to your main processing folder
...
FinalOutput.Properties.VariableNames{1} = 'F1_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{2} = 'FZ_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{3} = 'FC1_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{4} = 'FCZ_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{5} = 'FC2_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{6} = 'C1_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{7} = 'C2_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{8} = 'P1_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{9} = 'PZ_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{10} = 'P2_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{11} = 'PO3_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{12} = 'POZ_Delta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{13} = 'PO4_Delta_Rest_T_Pre';

FinalOutput.Properties.VariableNames{14} = 'F1_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{15} = 'FZ_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{16} = 'FC1_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{17} = 'FCZ_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{18} = 'FC2_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{19} = 'C1_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{20} = 'C2_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{21} = 'P1_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{22} = 'PZ_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{23} = 'P2_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{24} = 'PO3_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{25} = 'POZ_Theta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{26} = 'PO4_Theta_Rest_T_Pre';

FinalOutput.Properties.VariableNames{27} = 'F1_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{28} = 'FZ_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{29} = 'FC1_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{30} = 'FCZ_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{31} = 'FC2_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{32} = 'C1_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{33} = 'C2_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{34} = 'P1_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{35} = 'PZ_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{36} = 'P2_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{37} = 'PO3_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{38} = 'POZ_Alpha_Rest_T_Pre';
FinalOutput.Properties.VariableNames{39} = 'PO4_Alpha_Rest_T_Pre';

FinalOutput.Properties.VariableNames{40} = 'F1_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{41} = 'FZ_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{42} = 'FC1_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{43} = 'FCZ_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{44} = 'FC2_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{45} = 'C1_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{46} = 'C2_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{47} = 'P1_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{48} = 'PZ_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{49} = 'P2_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{50} = 'PO3_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{51} = 'POZ_Beta_Rest_T_Pre';
FinalOutput.Properties.VariableNames{52} = 'PO4_Beta_Rest_T_Pre';


%Prepare for final output
FinalOutput_R = [FinalOutput fullSetsName_list_transposed];
FinalOutput_R = movevars(FinalOutput_R, 'fullSetsName_list_transposed', 'Before', 'F1_Delta_Rest_T_Pre');
FinalOutput_R.Properties.VariableNames{1} = 'Subject';


%Excel output
filename = 'SAya_EC_EEG_Rest_T_Pre.xlsx'
