...
eeglab;
m_path = '/Volumes/Data/ZShared/SNEACY/2_SNEACY_YA/SNEACY_YA_EEG/Flanker_EEG/Flanker_EEG_Trier/Pre/';  % This is the path to your main processing folder
...
ERP = pop_savemyerp(ERP, 'erpname', 'SAya_pr_Flanker_T_', 'filename', 'SAya_pr_Flanker_T_.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SAya_pr_Flanker_T_','_erp_export.txt'], [13 14], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
% % 
% disp(',');
% disp('--------------------------------');
